...
$('#user-input').on('input', function () {
  $(this).val().trim() ? $('.device-info__service-modal .modal__save').removeAttr('disabled') : $('.device-info__service-modal .modal__save').attr('disabled', '');
  $userInput.removeClass('show-note js-error');
});
$('.device-info__service-modal .modal__save').on('click', function (e) {
  e.preventDefault();

  if ($('#user-input').val().match(REG_EXP.email) === null && $('#user-input').val().match(REG_EXP.phone) === null) {
